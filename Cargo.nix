  ...
  internal = rec {
    ...
    crates = {
      ...
      "fstn" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "reqwest";
            usesDefaultFeatures = false;
            features = [ "blocking" "json" "multipart" "stream" "rustls-tls" ];
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__tls" "blocking" "hyper-rustls" "json" "mime_guess" "multipart" "rustls" "rustls-pemfile" "rustls-tls" "rustls-tls-webpki-roots" "serde_json" "stream" "tokio-rustls" "tokio-util" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.20";
      ...
      "thiserror" = rec {
        ...
        version = "1.0.36";
        edition = "2018";
        sha256 = "08mi1cbar01x82pchwsf3iblvh4drhbvdlvwj3kz13ls9f6cp68a";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "thiserror-impl" = rec {
        ...
        version = "1.0.36";
        edition = "2018";
        sha256 = "0hzblzqr8jlhgd037a5avds2624hbxvb7pbkivn6zmn8sdh1i29s";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "default" "fs" "io-util" "libc" "memchr" "mio" "net" "num_cpus" "once_cell" "rt" "rt-multi-thread" "socket2" "sync" "time" "winapi" ];
      };
      "tokio-rustls" = rec {
      ...
      "webpki-roots" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1gkmk4baan9knbf3dggwyvh8bqmdvi8x6mmpicih3yv9g5jzx2rn";
        authors = [
          "Joseph Birr-Pixton <jpixton@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "accctrl" "aclapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "minwinbase" "minwindef" "namedpipeapi" "ntsecapi" "objbase" "processenv" "shlobj" "std" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
